...
-- Tiempo de generación: 05-03-2024 a las 22:03:18
...
ALTER TABLE `foros`
  ...
  ADD CONSTRAINT `Nombre_for` FOREIGN KEY (`Nombres`) REFERENCES `usuarios` (`Nombres`) ON DELETE RESTRICT ON UPDATE RESTRICT;
