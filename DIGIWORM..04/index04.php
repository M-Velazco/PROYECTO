        ...
        <a href="Principal.php" class="nav-item nav-link">Principal</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu rounded-0 m-0">
                    ...
                    <a href="Publicaciones.php" class="dropdown-item">Publicaciones</a>
                    <a href="Visual_padres" class="dropdown-item">Padres de Familia</a>
                    <a href="Visual_padres" class="dropdown-item">Boletines</a>
                </div>';
endif;
?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <p class="section-title pr-5"><span class="pr-2">Reserva Tu Cupo</span></p>
                    <h1 class="mb-4">Reserve un asiento para su hijo</h1>
                    <p>
                        
                        "¡El primer paso hacia un futuro brillante comienza con la reserva de tu cupo en nuestra institución! Únete a nosotros y prepárate para alcanzar tus metas académicas.¡Únete a nuestra comunidad educativa y descubre todo lo que podemos ofrecerte! Separa tu cupo hoy y conviértete en el arquitecto de tu propio destino académico."</p>
                    <ul class="list-inline m-0">
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>voy a trabajar duro para ellos</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>"Aprende hoy, lidera mañana."</li>
                        <li class="py-2"><i class="fa fa-check text-success mr-3"></i>"Cree en ti mismo. Eres más capaz de lo que piensas."</li>
                    </ul>
