...
<body>
    ...
    <div class="navbar">
        <div class="search-bar">
            <!-- Cambié el atributo action para que apunte al mismo archivo (index.php) -->
    ...
    <div class="content">
        ...
        // Verifica si hay información pasada como parámetro POST desde el mismo index.php
    ...
    <footer>
        <p>© <?php echo date("Y"); ?> Página para Padres</p>
    </footer>
